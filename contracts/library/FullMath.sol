...
library FullMath {
    /// @notice Returns a*b/denominator, throws is remainder is not 0
    function mulDiv(
        uint256 a,
        uint256 b,
        uint256 denominator
    ...
    function mulCompare(
        ...
        uint256 prod2; // Least significant 256 bits of the product
        uint256 prod3; // Most significant 256 bits of the product
        assembly {
